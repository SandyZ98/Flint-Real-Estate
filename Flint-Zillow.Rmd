...
```{r}
pipe<-read.dbf("SL_Conn_11_7.dbf",as.is = TRUE)
```
...
We will visualize the change in home values from 2013 to 2015, roughly when the Flint water crisis became public.
...
acs_geo%>%
  select(home_change_rate_1316, geometry) %>% 
=======
#Map of change in home values
acs_geo %>%
