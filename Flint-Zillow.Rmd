...
B01001A_018E: female under 5 years
B01001G_003E: male under 5 years
...
```{r Variable names}
acs5_names <-c("state","county","tract","income_black","income_white","f_black","m_black","black","white","m_white","f_white","f_under5","m_under5","fam_hh","hh","homevalue")
```

The state of Michigan is 026, and Genessee county is 049.

The metropolian statistical area is: 22420
...
#Comparative tables
flint_acscomp <- getCensus(name = "acs/acs5/cprofile",
                    vintage = 2017, 
...
vars = c("NAME", "B19001B_001E","B19001A_001E","B01001B_017E","B01001B_002E","B01001B_001E","B01001A_001E","B01001A_002E","B01001A_017E","B01001A_018E","B01001G_003E","B11016_002E","B11016_001E","B25107_001E"),
