...
```{r}
#Scatterplot of the number of cases for each structure age category for all tracts. Color according to age category 

flint_strage %>% arrange

ggplot(data=flint_acs5_clean) + geom_point(aes=)
