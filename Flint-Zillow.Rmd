...
#Reordering column order for reshaping
...
keep<-c("FULLNAME","FROMHN","TOHN","ZIP")
table_addr_clean<-na.omit(table_address[keep])
...
table_address <- merge(table_ID,table_names,by="LINEARID")
```

# Cleaning Zillow Data

```{r}
load("/tmp/mozilla_isle0/Zillow data.Rdata")
```
